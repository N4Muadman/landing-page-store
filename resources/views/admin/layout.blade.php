...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-layout="vertical" data-pc-direction="ltr"
                ...
                <div class="card pc-user-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0"><img src="{{ asset('adminAssets/images/avatar.jpg') }}"
                                    alt="user-image" class="user-avtar wid-45 rounded-circle"></div>
                            <div class="flex-grow-1 ms-3 me-2">
                                <h6 class="mb-0">{{ Auth::user()->name }}</h6><small>Vai trò: Admin</small>
                        ...
                        <div class="collapse pc-user-links" id="pc_sidebar_userlink">
                            <div class="pt-3"><a href=""><i class="ti ti-user"></i> <span>Tài khoản của
                                        tôi</span></a>
            ...
            <div class="ms-auto">
                <ul class="list-unstyled">
                    ...
                    <li class="dropdown pc-h-item header-user-profile"><a
                            ...
                            aria-expanded="false"><img src="{{ asset('adminAssets/images/avatar.jpg') }}"
                                ...
                                <div class="profile-notification-scroll position-relative"
                                    ...
                                    <div class="d-flex mb-1">
                                        <div class="flex-shrink-0"><img
                                                src="{{ asset('adminAssets/images/avatar.jpg') }}" alt="user-image"
                                                class="user-avtar wid-35"></div>
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1">{{ Auth::user()->name }} 🖖</h6><span>
    ...
    <footer class="pc-footer">
        <div class="footer-wrapper container-fluid">
            <div class="row">
                <div class="col my-1">
                    <p class="m-0"><a href="#" target="_blank">Gia Dụng Đoài Mai &#9829;</a></p>
                </div>
